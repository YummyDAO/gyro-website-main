...
export default ({
  ...
  heading = (
    <>
      Designed & Developed by <span tw="text-primary-500">AkidoDex.</span>
    </>
  ),
  description = false,
  textOnLeft = false
  ...
  const socialChannels = [
    {
      ...
      link: 'https://t.me/akidodex'
    },
    {
      Icon: TwitterIcon,
      title: 'Twitter',
      description: 'Follow @AkidoDex to get the latest news and updates from across the ecosystem',
      link: 'https://twitter.com/AkidoDex'
    },
    /*{
      Icon: DiscordIcon,
      title: 'Discord',
